...
@dp.table(
    name="workspace.bookmyshow_curated.bronze_theaters",
    comment="Raw theater master data ingested from the governed landing volume.",
    table_properties={
        "quality": "bronze",
        "domain": "bookmyshow",
...
@dp.expect_or_drop("theater_id_present", "theater_id IS NOT NULL")
@dp.expect_or_drop("theater_name_present", "theater_name IS NOT NULL")
def bronze_theaters():
    return (
