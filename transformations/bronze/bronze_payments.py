...
@dp.table(
    name="workspace.bookmyshow_curated.bronze_payments",
    comment="Raw payment and refund events ingested from the governed landing volume.",
    table_properties={
        "quality": "bronze",
        "domain": "bookmyshow",
...
@dp.expect_or_drop("payment_id_present", "payment_id IS NOT NULL")
