...
@dp.table(
    name="workspace.bookmyshow_curated.bronze_movies",
    comment="Raw movie catalog data ingested from the governed landing volume.",
    table_properties={
        "quality": "bronze",
        "domain": "bookmyshow",
...
@dp.expect_or_drop("movie_id_present", "movie_id IS NOT NULL")
@dp.expect_or_drop("title_present", "title IS NOT NULL")
def bronze_movies():
    return (
