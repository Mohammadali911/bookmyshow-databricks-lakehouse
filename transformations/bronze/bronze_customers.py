...
@dp.table(
    name="workspace.bookmyshow_curated.bronze_customers",
    comment="Raw customer master data ingested from the governed landing volume.",
    table_properties={
        "quality": "bronze",
        "domain": "bookmyshow",
...
@dp.expect_or_drop("customer_id_present", "customer_id IS NOT NULL")
@dp.expect_or_drop("email_present", "email IS NOT NULL")
def bronze_customers():
    return (
        ...
        .load(raw_entity_path("customers"))
