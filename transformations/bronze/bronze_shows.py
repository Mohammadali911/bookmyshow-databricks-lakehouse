...
@dp.table(
    name="workspace.bookmyshow_curated.bronze_shows",
    comment="Raw show schedule data ingested from the governed landing volume.",
    table_properties={
        "quality": "bronze",
        "domain": "bookmyshow",
...
@dp.expect_or_drop("show_start_present", "show_start_ts IS NOT NULL")
def bronze_shows():
    return (
